...
# Crypto
# The stock API level is 33. Keep both values aligned so Android 12-based
# recovery build trees do not report version 12 to Keymaster.
PLATFORM_VERSION := 13.0.0
PLATFORM_VERSION_LAST_STABLE := 13.0.0
